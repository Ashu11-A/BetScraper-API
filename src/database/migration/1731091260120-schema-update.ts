...
export class SchemaUpdate1731091260120 implements MigrationInterface {
  name = 'SchemaUpdate1731091260120'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `properties` (`id` int NOT NULL AUTO_INCREMENT, `content` text NOT NULL, `contrast` float NOT NULL, `proportionPercentage` float NOT NULL, `scrollPercentage` float NOT NULL, `distanceToTop` float NOT NULL, `isIntersectingViewport` tinyint NOT NULL, `isVisible` tinyint NOT NULL, `isHidden` tinyint NOT NULL, `hasChildNodes` tinyint NOT NULL, `isInViewport` tinyint NOT NULL, `colors` text NOT NULL, `viewport` text NOT NULL, `taskId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB')
