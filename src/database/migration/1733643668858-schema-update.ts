...
export class SchemaUpdate1733643668858 implements MigrationInterface {
  name = 'SchemaUpdate1733643668858'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE `properties` CHANGE `colors` `colors` text NOT NULL')
    await queryRunner.query('ALTER TABLE `properties` CHANGE `contrast` `contrast` float(12) NOT NULL')
    await queryRunner.query('ALTER TABLE `properties` ADD CONSTRAINT `FK_2256c34c6f602b4675cadd55c6e` FOREIGN KEY (`taskId`) REFERENCES `tasks`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION')
