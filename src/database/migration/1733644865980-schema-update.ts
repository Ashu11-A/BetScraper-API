...
export class SchemaUpdate1733644865980 implements MigrationInterface {
  name = 'SchemaUpdate1733644865980'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE `properties` CHANGE `isIntersectingViewport` `isIntersectingViewport` tinyint NOT NULL')
