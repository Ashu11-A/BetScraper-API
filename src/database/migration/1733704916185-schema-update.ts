...
export class SchemaUpdate1733704916185 implements MigrationInterface {
    name = 'SchemaUpdate1733704916185'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_2256c34c6f602b4675cadd55c6e\` ON \`properties\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_2256c34c6f602b4675cadd55c6e\` ON \`properties\` (\`taskId\`)`);
    }
